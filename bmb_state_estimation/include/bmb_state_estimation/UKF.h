...
private:
    ...
    static constexpr double beta = 2; // parameter to affect the weighting of the zeroth sigma point for the calculation of the covariance
    static constexpr double lambda = alpha * alpha * (n + kappa) - n; // scaling factor for sigma points
