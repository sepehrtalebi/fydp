...
ExprPtr Variable::simplify() const { return Variable::make(identifier); }

std::string Variable::toStr() const { return identifier; }

std::string Variable::getIdentifier() const { return identifier; }
