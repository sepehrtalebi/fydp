...
bmb_msgs::SensorMeasurements as_msg(
  ...
  msg.pressure_reading.fluid_pressure = sensor_measurements[bmb_msgs::SensorMeasurements::PRESSURE];
  msg.rail_detection.angle = sensor_measurements[bmb_msgs::SensorMeasurements::RAIL_ANGLE];
  msg.rail_detection.pixel_width = sensor_measurements[bmb_msgs::SensorMeasurements::RAIL_WIDTH];
  msg.rail_detection.pixel_x = sensor_measurements[bmb_msgs::SensorMeasurements::RAIL_x];
  msg.rail_detection.pixel_y = sensor_measurements[bmb_msgs::SensorMeasurements::RAIL_y];
  msg.rail_detection.found = sensor_measurements[bmb_msgs::SensorMeasurements::RAIL_FOUND];
  msg.optical_flow_reading.x_pixel_velocity = sensor_measurements[bmb_msgs::SensorMeasurements::PIXEL_vx];
  msg.optical_flow_reading.y_pixel_velocity = sensor_measurements[bmb_msgs::SensorMeasurements::PIXEL_vy];
  msg.imu_reading.orientation.w = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_q0];
  msg.imu_reading.orientation.x = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_q1];
  msg.imu_reading.orientation.y = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_q2];
  msg.imu_reading.orientation.z = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_q3];
  msg.imu_reading.angular_velocity.x = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_wx];
  msg.imu_reading.angular_velocity.y = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_wy];
  msg.imu_reading.angular_velocity.z = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_wz];
  msg.imu_reading.linear_acceleration.x = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_ax];
  msg.imu_reading.linear_acceleration.y = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_ay];
  msg.imu_reading.linear_acceleration.z = sensor_measurements[bmb_msgs::SensorMeasurements::IMU_az];
  msg.gps_reading.latitude = sensor_measurements[bmb_msgs::SensorMeasurements::LAT];
  msg.gps_reading.longitude = sensor_measurements[bmb_msgs::SensorMeasurements::LONG];
  msg.gps_reading.altitude = sensor_measurements[bmb_msgs::SensorMeasurements::ALT];
  return msg;
}
...
bmb_msgs::ControlInputs as_msg(const Vector3<double>& control_inputs) {
  ...
  msg.right_aileron_angle = control_inputs[bmb_msgs::ControlInputs::RIGHT_AILERON];
