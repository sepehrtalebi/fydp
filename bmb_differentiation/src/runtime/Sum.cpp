...
std::string Sum::type() const { return "+"; }

bool Sum::isAssociative() const { return true; }

bool Sum::isCommutative() const { return true; }
...
void operator+=(const double& num, ExprPtr& expr) { expr = expr + num; }