...
PyObject* get_array(const std::array<Numeric, n>& v)
{
    npy_intp vsize = n;
    NPY_TYPES type = select_npy_type<Numeric>::type;
    if (type == NPY_NOTYPE) {
...
bool plot(const std::vector<Numeric> &x, const std::vector<Numeric> &y, const std::map<std::string, std::string>& keywords)
{
    ...
    template<typename Numeric, size_t n>
    bool plot(const std::array<Numeric, n> &x, const std::array<Numeric, n> &y, const std::map<std::string, std::string>& keywords)
    {
        detail::_interpreter::get();
...
bool plot(const std::vector<NumericX>& x, const std::vector<NumericY>& y, const std::string& s = "")
{
    ...
    template<typename Numeric, size_t n>
    bool plot(const std::array<Numeric, n>& x, const std::array<Numeric, n>& y, const std::string& s = "")
    {
        detail::_interpreter::get();
