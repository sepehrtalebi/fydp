#include "bmb_differentiation/runtime/Difference.h"
...
std::string Difference::type() const { return "-"; }
...
ExprPtr operator-(const ExprPtr& expr1, const ExprPtr& expr2) {
  ...
  if (expr1 == Zero::INSTANCE)
    return std::make_shared<Product>(Constant::make(-1), expr2);
