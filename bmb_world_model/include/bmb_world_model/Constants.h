...
static const Vector3<double> L_RIGHT_AILERON{0, 1,
                                             0};  // NOLINT(cert-err58-cpp)
static const Vector3<double> L_LEFT_AILERON{
    L_RIGHT_AILERON[0], -L_RIGHT_AILERON[1],
    L_RIGHT_AILERON[2]};  // NOLINT(cert-err58-cpp)
...
static constexpr const double MIN_RADIUS_CURVATURE =
...
static constexpr const size_t p =
...
static constexpr const double TRIM =
